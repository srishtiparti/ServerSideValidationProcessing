...
var valid = [
    ...
    check('apple', '').custom(customQuantity)            // checking id all quantities are positive numbers and subtotal > $10
]
...
myApp.listen(2391); //http://localhost:2391
